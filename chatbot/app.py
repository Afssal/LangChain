...
st.title("Simple Chat bot using Groq and Langchain")
...
#you can modify thread_id.based on thread id previous messages will load.
config = {"configurable": {"thread_id": "abc123"}}


#generate response one by one word with 0.1 sec delay
